...
gatk --java-options "-Xmx5g" BaseRecalibrator -I splitn.bam -R /ijc/LABS/MERKEL/DATA/PROJECTS/idevillasante/20221005_MGraupera_PIK3CA-Var/RNAseq/manual/references/GENCODE.v40.fasta --known-sites /ijc/LABS/MERKEL/DATA/PROJECTS/idevillasante/20221005_MGraupera_PIK3CA-Var/RNAseq/manual/references/Homo_sapiens_assembly38.known_indels.vcf.gz -O recal_data.table

gatk --java-options "-Xmx5g"  ApplyBQSR -I splitn.bam -R /ijc/LABS/MERKEL/DATA/PROJECTS/idevillasante/20221005_MGraupera_PIK3CA-Var/RNAseq/manual/references/GENCODE.v40.fasta --bqsr-recal-file recal_data.table -O "clean_{$ID}.bam"
