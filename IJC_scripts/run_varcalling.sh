...
gatk --java-options "-Xmx5g" HaplotypeCaller  --input "clean_{$ID}.bam" --output "${ID}_raw_variants.vcf.gz" --reference /ijc/LABS/MERKEL/DATA/PROJECTS/idevillasante/20221005_MGraupera_PIK3CA-Var/RNAseq/manual/references/GENCODE.v40.fasta --dbsnp /ijc/LABS/MERKEL/DATA/PROJECTS/idevillasante/20221005_MGraupera_PIK3CA-Var/RNAseq/manual/references/Homo_sapiens_assembly38.known_indels.vcf.gz  --dont-use-soft-clipped-bases true --standard-min-confidence-threshold-for-calling 20.0 
